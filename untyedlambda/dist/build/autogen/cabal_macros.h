...
/* package untyedlambda-0.1.0.0 */
#define VERSION_untyedlambda "0.1.0.0"
#define MIN_VERSION_untyedlambda(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "untyedlambda-0.1.0.0"

#define CURRENT_PACKAGE_KEY "untyedlambda-0.1.0.0"
